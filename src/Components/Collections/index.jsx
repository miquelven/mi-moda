    ...
    <section className="mt-10 mb-40">
      <Container>
        ...
        <div className="relative grid grid-cols-3 justify-center items-center max-lg:grid-cols-2 max-sm:grid-cols-1">
          <div className=" flex flex-col gap-20 max-sm:relative max-sm:z-20 max-sm:-mt-14">
          ...
          <img
            ...
            className="shadow-md shadow-black/20 rounded-md max-sm:absolute max-sm:top-0 max-sm:right-0  max-sm:h-80 max-sm:brightness-75"
          />
        </div>
      </Container>
    </section>
